...
//?Booleans
const planes = 'Airbus A320neo B737-800';
console.log(planes.includes('A320'));
console.log(planes.includes('Boeing'));
console.log(planes.startsWith('Airbus'));
console.log(planes.endsWith('-800'));

if (planes.startsWith('Airbus') && planes.endsWith('-800'))
...
console.log('Raphael Michael'.split(' '));

const [firstName, lastName] = 'Raphael Michael'.split(' ');
...
capitaliseName('jesssica ann smith davis');
capitaliseName('raphael michael');
